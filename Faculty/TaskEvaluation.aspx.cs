...
{
    public partial class TaskEvaluation : System.Web.UI.Page
    {
        ...
        protected void AssignmentGrid_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "DownloadAssignment" || e.CommandName == "DownloadFeedback")
            {
                Document downloadDoc;
                if (e.CommandName == "DownloadAssignment")
            ...
            {
                Response.Redirect("~/Faculty/TaskRating.aspx?versid=" + versid); 
            }
