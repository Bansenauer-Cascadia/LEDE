<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignmentRating.aspx.cs" Inherits="ByTheBook" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Submit Task Assemsent</title>
    <style type="text/css">
        .auto-style2 {
            font-size: large;
        }
...
<body>
    ...
    <div>
        ...
        Student: <asp:DropDownList ID="StudentDropDown" runat="server" DataSourceID="StudentDataSource"
            datatextfield="name" DataValueField="id" AutoPostBack="true"></asp:DropDownList> <br />
        ...
        <br />
        <br />
        <span class="auto-style2"><strong>Edit Core Rating Assesments</strong></span> 
        <asp:ListView ID="ListView1" runat="server" DataSourceID="CoreRatingDataSource" DataKeyNames="coretopicid,versid" InsertItemPosition="FirstItem">            
            <EditItemTemplate>
                <tr style="">                    
                    <td>
        ...
        <span class="auto-style2"><strong>Edit Impact Type Assessments:
        </strong></span><strong>
                ...
                <table runat="server">
                    <tr runat="server">
                        <td runat="server">
                            <table id="itemPlaceholderContainer" runat="server" border="0" style="">
                                <tr runat="server" style="">                                    
                                    <th runat="server">Impact Type</th>
