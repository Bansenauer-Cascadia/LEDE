...
{     
    ...
    {
        public enum ledeRoles {Candidate, Faculty, LEDE_Admin, ECSEL_Admin, Super_Admin };

        public void getRoles()
        {
            IEnumerable<ledeRoles> values =

                      Enum.GetValues(typeof(ledeRoles))
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, ledeRoles Roles)
        {
            if (ModelState.IsValid)
            {
                var user = new User() { UserName = model.Email, Email = model.Email, UniversityID = model.UniversityID,
                FirstName = model.FirstName, LastName = model.LastName};
                  ...
                  // Your code...
                    ...
                    if (result.Succeeded)
                    {
                        await UserManager.AddToRoleAsync(user.Id, Roles.ToString());                         
